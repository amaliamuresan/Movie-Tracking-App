...
public class LoginService {
    ...
    public User postToServer(String email,String password) throws CertificateException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException, IOException {
        ...
        user=restT.postForObject(processedURL,params,User.class);
        return user;
    }
}
