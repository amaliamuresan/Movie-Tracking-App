...
<script>
function removeWatched(name,el) {
  ...
  xhttp.open("GET", "/user/removeWatched/"+name, true);
  xhttp.send();
}
</script>
                               ...
                               <div class="card-body">
                                 ...
                                 <div class="d-flex justify-content-between align-items-center">
                                   <div class="btn-group">
                                           ...
                                           <button type="button" class="btn btn-sm btn-outline-secondary" onclick="removeWatched('${movie.id}',this)"><c:choose> <c:when test="${user.watched_movies.contains(movie.id)}">Watched</c:when><c:otherwise>Remove</c:otherwise></c:choose></button>
                                   </div>
